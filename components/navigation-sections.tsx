  ...
  return (
    <div className={className}>
      {sections.map((section, sectionIndex) => {
        const sectionWebsites = websites.filter(
        ...
        return (
          ...
          >
            ...
            <div className="flex items-center gap-2.5 sm:gap-3.5 mb-4 sm:mb-6">
              <div className="text-xl sm:text-2xl md:text-3xl w-9 h-9 sm:w-11 sm:h-11 flex items-center justify-center rounded-lg sm:rounded-xl bg-white dark:bg-slate-800/80 shadow-sm border border-slate-200/80 dark:border-slate-700/60">
                {section.icon}
              </div>
              <div className="flex-1 min-w-0">
                <h2 className="text-base sm:text-lg md:text-xl font-bold text-foreground tracking-tight truncate">
                  {section.title}
                </h2>
              </div>
              <span className="text-[11px] sm:text-xs text-muted-foreground bg-slate-100 dark:bg-slate-800 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full font-medium tabular-nums flex-shrink-0">
