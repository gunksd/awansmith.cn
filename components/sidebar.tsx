  ...
  return (
    <>
      ...
      <Button
        ...
        className="fixed top-4 left-4 z-50 md:hidden bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border border-slate-200 dark:border-slate-700 shadow-md"
      >
      ...
      <motion.aside
        ...
        className={`
          fixed left-0 top-0 h-screen bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700 shadow-xl z-50
          md:block
      ...
      >
        ...
        <Button
          ...
          className="absolute -right-3 top-6 z-10 rounded-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 shadow-md hover:shadow-lg transition-all hidden md:flex"
        >
